...
const CadastroPage = () => {
  ...
  // 2. CORRIGIDO: O estado do formulário usa os nomes exatos do backend
  const [formData, setFormData] = useState({
    nome: '',
    ddata_nascimento: '',
    cpf: '',
    email: '',
    senha: '' // Alterado de 'password'
  });
  
  // 3. LÓGICA DE TEMA ADICIONADA
      ...
      <div className="login-panel-right">
        ...
        <div className="login-form-container">
          <form className="login-form" onSubmit={handleSubmit}>
            ...
            {/* 4. CORRIGIDO: Os 'name' dos inputs correspondem ao estado */}
            <div className="input-group">
              <label htmlFor="nome_completo">Nome Completo</label>
              <input type="text" id="nome_completo" name="nome_completo" value={formData.nome_completo} onChange={handleChange} placeholder="O seu nome completo" required />
            </div>
            <div className="input-group">
              <label htmlFor="ddata_nascimento">Data de nascimento</label>
              <input type="date" id="ddata_nascimento" name="ddata_nascimento" value={formData.ddata_nascimento} onChange={handleChange} required />
            </div>
            <div className="input-group">
